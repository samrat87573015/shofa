...
<!-- header-area-start -->
<header>
   <?php if(!empty($shofa_topbar_switch) && !empty($shofa_header_top_text)) : ?>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-2 col-lg-3">
                        <div class="cat-menu__category p-relative">
                           <a class="tp-cat-toggle" href="#" role="button"><i class="fal fa-bars"></i><?php echo shofa_kses($shofa_header_pcat_title); ?></a>
