<?php
	...
	class TP_Subscriber_Widget  extends WP_Widget{
		...
		public function __construct(){
			parent::__construct('tp_subscriber_widget',esc_html__('Ninico Footer Subscriber','tocore'),array(
				'description' => esc_html__('Ninico Subscriber Widget','tocore'),
			));
		}
		...
		?>
			...
			<div class="footer__subscribe">
				<?php if( !empty($instance['title']) ): ?>	
					<h4 class="footer-widget__title mb-30"><?php echo apply_filters( 'widget_title', $instance['title'] ); ?></h4>
				<?php endif; ?>
