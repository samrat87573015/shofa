...
class TP_Contact_Form extends Widget_Base {
    ...
    protected function style_tab_content(){
        $this->tp_section_style_controls('contact_form_section', 'Section - Style', '.ele-section');
        $this->tp_basic_style_controls('contact_form_sub_title', 'Contact Form Sub Title - Style', '.ele-sub-title');
        $this->tp_basic_style_controls('contact_form_title', 'Contact Form Title - Style', '.ele-title');
        $this->tp_basic_style_controls('contact_form_content', 'Contact Form Content - Style', '.ele-content');
    }
...
<?php if ( $settings['tp_design_style']  == 'layout-2' ):
    $this->add_render_attribute('title_args', 'class', 'tpcontact__title ele-title');
?>

<div class="tpcontact__form ele-section">
    <div class="tpcontact__info mb-35">
        <?php if ( !empty($settings['tp_sub_title']) ) : ?>
        <h5 class="tpcta__subtitle ele-sub-title"><?php echo tp_kses( $settings['tp_sub_title'] ); ?></h5>
        <?php endif; ?>
        <?php
        ...
        <p class="ele-content"><?php echo tp_kses( $settings['tp_description'] ); ?></p>
        <?php endif; ?>
    </div>
    <div class="contact_form_style_2">
...
<?php else :
    $this->add_render_attribute('title_args', 'class', 'tpcta__title mb-30 ele-title');
?>

<div class="tpcta slider-bg text-center ele-section">
    <?php if ( !empty($settings['tp_sub_title']) ) : ?>
    <h5 class="tpcta__subtitle ele-sub-title"><?php echo tp_kses( $settings['tp_sub_title'] ); ?></h5>
    <?php endif; ?>
    <?php
