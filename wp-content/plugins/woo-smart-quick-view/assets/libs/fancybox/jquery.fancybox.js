  ...
  $.extend(FancyBox.prototype, {
          ...
          one('load', function() {
            ...
            if (slide.opts.image.srcset) {
              $img.attr('sizes', '100vw').
                  attr('srcset', slide.opts.image.srcset);
            }
    ...
    focus: function() {
      ...
      if (current && current.isComplete) {
        ...
        if (!$el.length) {
          $el = current.$slide.find('button,:input,[tabindex],a').
    ...
    close: function(e, d) {
      ...
      // Remove other slides
      current.$slide.off(transitionEnd).
          removeClass(
    ...
    cleanUp: function(e) {
      ...
      if (instance) {
        ...
        if ($body.hasClass('fancybox-iosfix')) {
          ...
          $body.removeClass('fancybox-iosfix').
              css('top', '').
              scrollTop(offset * -1);
        }
    ...
    updateControls: function(force) {
      ...
      if (current.type === 'image') {
        ...
        $container.find('[data-fancybox-download]').
  ...
  Guestures.prototype.onTap = function(e) {
    ...
    if ($target.is(
      ...
      where = 'Slide';
        ...
        instance.current.$content.find($target).
            addBack().
  ...
  $.extend(FancyThumbs.prototype, {
    ...
    create: function() {
      ...
      self.$grid = $(
          ...
          '"></div>').
          appendTo(instance.$refs.container.find(parentEl).
              addBack().
              filter(parentEl));
    ...
    focus: function(duration) {
      ...
      if (self.instance.current) {
        ...
        if (self.opts.axis === 'y' && (thumbPos.top < 0 || thumbPos.top >
          ...
          $list.stop().
              animate({'scrollTop': $list.scrollTop() + thumbPos.top},
                  duration);
